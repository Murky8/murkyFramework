...
namespace murkyFramework {
    ...
    struct Moof : public Zoof
    {
        Moof()
        {
            debugLog << id << L":  moof constructor\n";
        }
        
        ~Moof()
        {
            debugLog << id << L":  moof deconstructor\n";
        }
    };

    struct Doof : public Moof
    {
        Doof()
        {
            debugLog << id << L":  doof constructor\n";
        }
        ~Doof()
        {
            debugLog << id << L":  doof deconstructor\n";
        }
    };
    ...
    void skool()
    {
		//froif
        {
            ...
            debugLog << (int)sizeof(Zoof) << L"  sizeof(Zoof) \n";
            debugLog << (int)sizeof(Zoof*) << L"  sizeof(Zoof*) \n";
