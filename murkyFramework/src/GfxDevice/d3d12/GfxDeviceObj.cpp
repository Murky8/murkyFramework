                ...
                { // upload 1st texture
                  ...
                  // Describe  Texture2D.
                    ...
                    ThrowIfFailed(m_device->CreateCommittedResource(
                        ...
                        nullptr,
                        IID_PPV_ARGS(&m_texture[0])));

                    const UINT64 uploadBufferSize = GetRequiredIntermediateSize(m_texture[0].Get(), 0, 1);
                    ...
                    //					width, height);
                    {
                        GfxDevice::loadTextureDataFromFile(myTexture, L"data", L"t0 4c", L"png",
                            width, height);
                    ...
                    UpdateSubresources(g_commandList.Get(), m_texture[0].Get(), textureUploadHeap.Get(), 0, 0, 1,
                        &textureData);
                    g_commandList->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(m_texture[0].Get(),
                    ...
                    m_device->CreateShaderResourceView(m_texture[0].Get(), &srvDesc, srvHandle);
                ...
                { // upload 2nd texture
                  ...
                  // Describe  Texture2D.
                    ...
                    ThrowIfFailed(m_device->CreateCommittedResource(
                        ...
                        D3D12_RESOURCE_STATE_COPY_DEST,
                        nullptr,
                        IID_PPV_ARGS(&m_texture[1])));

                    const UINT64 uploadBufferSize = GetRequiredIntermediateSize(m_texture[1].Get(), 0, 1);
                    ...
                    {
                        GfxDevice::loadTextureDataFromFile(myTexture, L"data", L"font 4c", L"png",
                            width, height);
                    ...
                    UpdateSubresources(g_commandList.Get(), m_texture[1].Get(), textureUploadHeap2.Get(), 0, 0, 1,
                        &textureData);
                    g_commandList->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(m_texture[1].Get(),
                        D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE));
                    ...
                    m_device->CreateShaderResourceView(m_texture[1].Get(), &srvDesc, srvHandle);
                    srvHandle.Offset(m_srvDescriptorSize);
                } // upload 2nd texture		
            }
        }
