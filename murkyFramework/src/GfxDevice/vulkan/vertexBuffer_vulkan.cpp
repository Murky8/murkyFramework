...
*/
            ...
            capacity(nVerts)
        {
            ...
            //glBufferData(GL_ARRAY_BUFFER, 0, NULL, GL_DYNAMIC_DRAW); // unsure if needed; test
            //                                                         // reset state		
        ...
        void	VertexIndexBufferWrapper::draw(void *vertices, u16 nVertices, u16 *indices, u32 nPrimatives)
        {
            ...
            //glBindBuffer(GL_ARRAY_BUFFER, vbo);
            ////glBufferSubData(GL_ARRAY_BUFFER, 0, nPrimatives*nVerticiesPerPrimative*sizeVertex, data);
            //glBufferData(GL_ARRAY_BUFFER, nVertices*sizeVertex, vertices, GL_DYNAMIC_DRAW);


            //glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ibo);
            //glBufferData(GL_ELEMENT_ARRAY_BUFFER, nPrimatives*nVerticiesPerPrimative*sizeof(u16), indices, GL_DYNAMIC_DRAW);
            ...
            //glDrawElements(
            //     GL_TRIANGLES,      // mode
            //    nPrimatives*nVerticiesPerPrimative,    // count
