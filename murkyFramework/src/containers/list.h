...
// this is shit FIX!!
// not necessary for header, tail elements. waste
...
{
public:
	ClistElement<T>	*pPrev;//dont change! hardcoded ref from data
	ClistElement<T>	*pNext;//dont change! hardcoded ref from data
	T	data;
...
//class	ClistElementpool // should be the new Cpool class
template	< class T >
